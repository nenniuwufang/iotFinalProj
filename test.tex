...
For security, we use the Shiro security rights management framework, the JWT single sign-on module to verify the user's identity, and all the network requests and background function calls are stored in the Log4j2 database.
...
\subsection{NFC working underlying principle}
